...
https://12cjn.github.io/docsify-demo/
...
```bash {.line-numbers}
cd existing_repo
git remote add origin https://gitlab.com/Yomiya_lizi/LeaningDjango4.0.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Yomiya_lizi/LeaningDjango4.0/-/settings/integrations)
